...
ENV JULIA_PROJECT "@."
WORKDIR /workspace/PCRP.jl

USER root
RUN chown -R ${NB_UID} /workspace/PCRP.jl
USER ${USER}

RUN mkdir -p /workspace/PCRP.jl/src && echo "module PCRP end" > /workspace/PCRP.jl/src/PCRP.jl
COPY ./Project.toml /workspace/PCRP.jl
